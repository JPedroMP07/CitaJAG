(function() {
	...
	// Set up the canvas
	var canvas = document.getElementById("sig-canvasArb1");
	var ctx = canvas.getContext("2d");
	ctx.strokeStyle = "#222222";
	ctx.lineWith = 2;

	// Set up the UI
	var sigText = document.getElementById("sig-dataUrlArb1");
	var sigImage = document.getElementById("sig-imageArb1");
	var clearBtn = document.getElementById("sig-clearBtnArb1");
	var submitBtn = document.getElementById("sig-submitBtnArb1");

	$("#sig-clearBtnArb1").click(function() {
	...
	canvas.addEventListener("touchmove", function (e) {
	  ...
	  document.querySelectorAll("#sig-canvasArb1").forEach(canvas => {
	...
	(function drawLoop () {
        ...
        const areaAssinatura = document.getElementById("canvasDivArb1");
        const botaoApagar = document.getElementById("sig-clearBtnArb1");
        const botaoSalvar = document.getElementById("sig-submitBtnArb1");
        const urlImagem = document.getElementById("sig-dataUrlArb1");
		const divImage = document.getElementById("sig-imageArb1");
