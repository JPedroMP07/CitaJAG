(function() {
	...
	// Set up the canvas
	var canvas = document.getElementById("sig-canvasArb2");
	var ctx = canvas.getContext("2d");
	ctx.strokeStyle = "#222222";
	ctx.lineWith = 2;

	// Set up the UI
	var sigText = document.getElementById("sig-dataUrlArb2");
	var sigImage = document.getElementById("sig-imageArb2");
	var clearBtn = document.getElementById("sig-clearBtnArb2");
	var submitBtn = document.getElementById("sig-submitBtnArb2");

	$("#sig-clearBtnArb2").click(function() {
	...
	canvas.addEventListener("touchmove", function (e) {
	  ...
	  document.querySelectorAll("#sig-canvasArb2").forEach(canvas => {
	...
	(function drawLoop () {
        ...
        const areaAssinatura = document.getElementById("canvasDivArb2");
        const botaoApagar = document.getElementById("sig-clearBtnArb2");
        const botaoSalvar = document.getElementById("sig-submitBtnArb2");
        const urlImagem = document.getElementById("sig-dataUrlArb2");
		const divImage = document.getElementById("sig-imageArb2");
