...
;
	$("#sig-clearBtn3").click(function() {
		ctx.clearRect(0, 0, ctx.canvas.width, ctx.canvas.height);
		ctx.beginPath();
	});

	$("#sig-submitBtn3").click(function() {
	...
	canvas.addEventListener("touchmove", function (e) {
	  ...
	  document.querySelectorAll("#sig-canvas3").forEach(canvas => {
	...
	(function drawLoop () {
        ...
        const areaAssinatura = document.getElementById("canvasDiv3");
        const botaoApagar = document.getElementById("sig-clearBtn3");
        const botaoSalvar = document.getElementById("sig-submitBtn3");
        const urlImagem = document.getElementById("sig-dataUrl3");
		const divImage = document.getElementById("sig-image3");
