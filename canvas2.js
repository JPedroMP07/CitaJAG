(function() {
	...
	document.querySelectorAll("#sig-canvas2").forEach(canvas => {
	...
	(function drawLoop () {
        ...
        const areaAssinatura = document.getElementById("canvasDiv2");
        const botaoApagar = document.getElementById("sig-clearBtn2");
        const botaoSalvar = document.getElementById("sig-submitBtn2");
        const urlImagem = document.getElementById("sig-dataUrl2");
        const divImage = document.getElementById("sig-image2");
