(function() {
	...
	// Set up the canvas
	var canvas = document.getElementById("sig-canvasArb3");
	var ctx = canvas.getContext("2d");
	ctx.strokeStyle = "#222222";
	ctx.lineWith = 2;

	// Set up the UI
	var sigText = document.getElementById("sig-dataUrlArb3");
	var sigImage = document.getElementById("sig-imageArb3");
	var clearBtn = document.getElementById("sig-clearBtnArb3");
	var submitBtn = document.getElementById("sig-submitBtnArb3");
	$("#sig-clearBtnArb3").click(function() {
	...
	submitBtn.addEventListener("click", function (e) {
		...
		let assinatura = "assCronometrista";
		$.ajax({
	...
	document.querySelectorAll("#sig-canvasArb3").forEach(canvas => {
	...
	(function drawLoop () {
        ...
        const areaAssinatura = document.getElementById("canvasDivArb3");
        const botaoApagar = document.getElementById("sig-clearBtnArb3");
        const botaoSalvar = document.getElementById("sig-submitBtnArb3");
        const urlImagem = document.getElementById("sig-dataUrlArb3");
		const divImage = document.getElementById("sig-imageArb3");
