(function() {
	...
	(function drawLoop () {
        ...
        const areaAssinatura = document.getElementById("canvasDiv");
        const botaoApagar = document.getElementById("sig-clearBtn");
        const botaoSalvar = document.getElementById("sig-submitBtn");
        const urlImagem = document.getElementById("sig-dataUrl");
        const divImage = document.getElementById("sig-image");
