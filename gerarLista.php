<?php 
    ...
    if(!($_SESSION['funcao'] == "arbitragem") && !($_SESSION['funcao'] == "admin")) {
     ...
     if(count($_POST)>=1) {
        ...
        $_SESSION["categoriaLista"] = $nomeCategoria;
        $_SESSION["equipeLista"] = $nomeEquipe;

        header("Location: gerarListaPDF");
        die();
    }
?>
    ...
    <main>
        <div id="inicio" class="inicio">
            <form action="" method="POST">
                ...
                <button class="btn button-cadastrar" type="submit">Gerar Lista</button>
            </form>
        </div>
    </main>
    <footer>
